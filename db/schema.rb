...
ActiveRecord::Schema.define(version: 20121105070904) do
  ...
  add_index "polling_locations", ["early_vote", "state", "city", "zip", "line1"], name: "index_polling_locations_on_address", using: :btree
  ...
  add_index "reviews", ["user_id", "polling_location_id"], name: "index_reviews_on_user_id_and_polling_location_id", unique: true, using: :btree

  create_table "state_map_data", id: false, force: true do |t|
